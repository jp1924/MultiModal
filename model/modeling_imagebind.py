...
_CHECKPOINT_FOR_DOC = "openai/ImageBind-vit-base-patch32"

ImageBind_PRETRAINED_MODEL_ARCHIVE_LIST = [
    "openai/ImageBind-vit-base-patch32",
    # See all ImageBind models at https://huggingface.co/models?filter=ImageBind
]


# contrastive loss function, adapted from
# https://sachinruk.github.io/blog/2021-03-07-ImageBind.html
...
class ImageBindAudioModelOutput(ModelOutput):
    """
    Base class for audio model's outputs that also contains image embeddings of the pooling of the last hidden states.
...
class ImageBindDepthModelOutput(ModelOutput):
    """
    Base class for depth model's outputs that also contains image embeddings of the pooling of the last hidden states.
...
class ImageBindThermalModelOutput(ModelOutput):
    """
    Base class for thermal model's outputs that also contains image embeddings of the pooling of the last hidden states.
...
class ImageBindIMUModelOutput(ModelOutput):
    """
    Base class for imu model's outputs that also contains image embeddings of the pooling of the last hidden states.
...
class ImageBindVideoEmbeddings(nn.Module):
    def __init__(self, config: ImageBindVisionConfig):
        super().__init__()
        self.config = config
        self.embed_dim = config.hidden_size
...
class ImageBindEncoder(nn.Module):
    ...
    def __init__(self, config: ImageBindConfig):
        ...
        self.layers = nn.ModuleList(
            [ImageBindEncoderLayer(config) for _ in range(config.num_hidden_layers)]
        )
...
class ImageBindTextTransformer(nn.Module):
    ...
    @replace_return_docstrings(
        output_type=BaseModelOutputWithPooling, config_class=ImageBindTextConfig
    )
    def forward(
        self,
        ...
        if self.eos_token_id == 2:
            ...
            # A ImageBind model with such `eos_token_id` in the config can't work correctly with extra new tokens added
            # ------------------------------------------------------------
...
class ImageBindTextModel(ImageBindPreTrainedModel):
    ...
    _no_split_modules = ["ImageBindTextEmbeddings", "ImageBindEncoderLayer"]
    ...
    def forward(
        ...
        >>> model = ImageBindTextModel.from_pretrained("openai/ImageBind-vit-base-patch32")
        >>> tokenizer = AutoTokenizer.from_pretrained("openai/ImageBind-vit-base-patch32")
...
class ImageBindVisionTransformer(nn.Module):
    ...
    @replace_return_docstrings(
        output_type=BaseModelOutputWithPooling, config_class=ImageBindVisionConfig
    )
    def forward(
        self,
...
class ImageBindVisionModel(ImageBindPreTrainedModel):
    ...
    def forward(
        ...
        >>> model = ImageBindVisionModel.from_pretrained("openai/ImageBind-vit-base-patch32")
        >>> processor = AutoProcessor.from_pretrained("openai/ImageBind-vit-base-patch32")
...
class ImageBindModel(ImageBindPreTrainedModel):
    ...
    def __init__(self, config: ImageBindConfig):
        ...
        self.audio_model = ImageBindVisionTransformer(audio_config)
        self.depth_model = ImageBindVisionTransformer(depth_config)
        self.thermal_model = ImageBindVisionTransformer(thermal_config)
        self.imu_model = None  # TODO: IMU encoder 구현하기
    ...
    def get_text_features(
        ...
        >>> model = ImageBindModel.from_pretrained("openai/ImageBind-vit-base-patch32")
        >>> tokenizer = AutoTokenizer.from_pretrained("openai/ImageBind-vit-base-patch32")
    ...
    def get_audio_features(self) -> torch.FloatTensor:
        return

    def get_depth_features(self) -> torch.FloatTensor:
        return

    def get_thermal_features(self) -> torch.FloatTensor:
        return

    def get_imu_features(self) -> torch.FloatTensor:
        return
...
class ImageBindTextModelWithProjection(ImageBindPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(ImageBind_TEXT_INPUTS_DOCSTRING)
    @replace_return_docstrings(
        output_type=ImageBindTextModelOutput, config_class=ImageBindTextConfig
    )
    def forward(
        self,
        input_ids: Optional[torch.Tensor] = None,
        ...
        >>> model = ImageBindTextModelWithProjection.from_pretrained("openai/ImageBind-vit-base-patch32")
        >>> tokenizer = AutoTokenizer.from_pretrained("openai/ImageBind-vit-base-patch32")
...
class ImageBindVisionModelWithProjection(ImageBindPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(ImageBind_VISION_INPUTS_DOCSTRING)
    @replace_return_docstrings(
        output_type=ImageBindVisionModelOutput, config_class=ImageBindVisionConfig
    )
    def forward(
        self,
        pixel_values: Optional[torch.FloatTensor] = None,
        ...
        >>> model = ImageBindVisionModelWithProjection.from_pretrained("openai/ImageBind-vit-base-patch32")
        >>> processor = AutoProcessor.from_pretrained("openai/ImageBind-vit-base-patch32")
...
class ImageBindAudioModelWithProjection(ImageBindPreTrainedModel):
    ...
    def __init__(self, config: ImageBindAudioConfig):
        ...
        self.audio_model = ImageBindVisionTransformer(config)
...
class ImageBindDepthModelWithProjection(ImageBindPreTrainedModel):
    ...
    def __init__(self, config: ImageBindDepthConfig):
        ...
        self.depth_model = ImageBindVisionTransformer(config)
...
class ImageBindThermalModelWithProjection(ImageBindPreTrainedModel):
    ...
    def __init__(self, config: ImageBindThermalConfig):
        ...
        self.thermal_model = ImageBindVisionTransformer(config)
    ...
    @add_start_docstrings_to_model_forward(ImageBind_VISION_INPUTS_DOCSTRING)
    @replace_return_docstrings(
        output_type=ImageBindVisionModelOutput,
        config_class=ImageBindVisionConfig,
    )
    def forward(
        self,
