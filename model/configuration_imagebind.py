...
class ImageBindTextConfig(PretrainedConfig):
    ...
    [openai/ImageBind-vit-base-patch32](https://huggingface.co/openai/ImageBind-vit-base-patch32) architecture.
    ...
    >>> # Initializing a ImageBindTextConfig with openai/ImageBind-vit-base-patch32 style configuration
    >>> configuration = ImageBindTextConfig()

    >>> # Initializing a ImageBindTextModel (with random weights) from the openai/ImageBind-vit-base-patch32 style configuration
    ...
    def __init__(
        ...
        # This differs from `ImageBindTokenizer`'s default and from openai/ImageBind
...
class ImageBindVisionConfig(PretrainedConfig):
    ...
    >>> # Initializing a ImageBindVisionConfig with openai/ImageBind-vit-base-patch32 style configuration
    >>> configuration = ImageBindVisionConfig()

    >>> # Initializing a ImageBindVisionModel (with random weights) from the openai/ImageBind-vit-base-patch32 style configuration
...
class ImageBindConfig(PretrainedConfig):
    ...
    >>> # Initializing a ImageBindConfig with openai/ImageBind-vit-base-patch32 style configuration
    >>> configuration = ImageBindConfig()

    >>> # Initializing a ImageBindModel (with random weights) from the openai/ImageBind-vit-base-patch32 style configuration
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if audio_config_dict is not None:
            ...
            # convert keys to string instead of integer
            if "id2label" in _audio_config_dict:
                _audio_config_dict["id2label"] = {
                    str(key): value for key, value in _audio_config_dict["id2label"].items()
                }

            # Give a warning if the values exist in both `_audio_config_dict` and `audio_config` but being different.
            for key, value in _audio_config_dict.items():
                if (
                    key in audio_config
                    and value != audio_config[key]
                    and key not in ["transformers_version"]
                ):
            ...
            # Update all values in `audio_config` with the ones in `_audio_config_dict`.
        ...
        if depth_config_dict is not None:
            ...
            _depth_config_dict = ImageBindAudioConfig(**depth_config_dict).to_dict()
            # convert keys to string instead of integer
            ...
            # Update all values in `depth_config` with the ones in `_depth_config_dict`.
        ...
        if thermal_config_dict is not None:
            ...
            _thermal_config_dict = ImageBindAudioConfig(**thermal_config_dict).to_dict()
            # convert keys to string instead of integer
            ...
            for key, value in _thermal_config_dict.items():
                if (
                    key in thermal_config
                    and value != thermal_config[key]
                    and key not in ["transformers_version"]
                ):
            ...
            # Update all values in `thermal_config` with the ones in `_thermal_config_dict`.
        ...
        if imu_config_dict is not None:
            ...
            _imu_config_dict = ImageBindAudioConfig(**imu_config_dict).to_dict()
            # convert keys to string instead of integer
    ...
    @classmethod
    def from_text_vision_audio_depth_thermal_imu_configs(
        cls,
        ...
        **kwargs,
        ...
        return cls(
            ...
            depth_config=depth_config.to_dict(),
            thermal_config=thermal_config.to_dict(),
            imu_config=imu_config.to_dict(),
            **kwargs,
        )
